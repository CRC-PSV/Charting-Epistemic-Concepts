...
if __name__ == '__main__':
    ...
    # Test corpus
    d0 = ('doc_0', ['This', 'is', 'a', 'test', 'sentence'])
    d1 = ('doc_1', ['This', 'is', 'another', 'example', 'sequence', 'of', 'words'])
    d2 = ('doc_2', ['And', 'finally', 'a', 'last', 'one'])
    test_corpus = [d0, d1, d2]


    dtc = DocTermModel()
    dtc.update('t1', t1)
    dtc.update('t2', t2)
    dtc.filter_words(lambda x: 'j' not in x)
    print(dtc.as_df())
